...
public class App {
  ...
  private void setInputs() {
    ...
    // NUMBER BUTTONS
    //
    JButton[] NumberButtons = { btn_OneButton, btn_TwoButton, btn_ThreeButton, btn_FourButton, btn_FiveButton, btn_SixButton, btn_SevenButton, btn_EightButton, btn_NineButton, btn_ZeroButton };
    for (JButton btn_NumButton: NumberButtons) {
      btn_NumButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          displayedNumber = Integer.parseInt(displayedString);
    ...
    for (JButton btn_OpButton: OperatorButtons) {
      btn_OpButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
          switch(currentStep++) {
            case 0: firstNumber = displayedNumber;
                    displayedString = "";
                    displayedNumber = 0;
                    break;
            case 1: secondNumber = displayedNumber;
                    displayedString = "";
                    displayedNumber = 0;
  ...
  private static Integer operateNumbers(Integer firstNum, Integer secondNum, Integer operator) {
    int result = 0;
    switch(operator) {
      case 0: result = firstNum + secondNum;
              break;
  ...
  private Integer displayedNumber = 0;
